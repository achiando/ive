...
export function EventAnalytics({ events = [], isLoading, className }: EventAnalyticsProps) {
  ...
  const totalNewEvents = displayData.reduce((sum, data) => sum + data.count, 0);
  const averagePerMonth = displayData.length > 0 ? Math.round(totalNewEvents / displayData.length) : 0;
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Track event creation trends and growth patterns
              </p>
            </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card className="border-l-4 border-l-blue-500">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">Total New Events</p>
                    <p className="text-2xl font-bold text-blue-600">{totalNewEvents}</p>
                  </div>
                  ...
                  <div key={`${data.year}-${data.month}`} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm text-muted-foreground">New Events</span>
          ...
          {displayData.length === 0 && (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p>No event creation data available for the selected period.</p>
            </div>
          )}
        </CardContent>
      </Card>
